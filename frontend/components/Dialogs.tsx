...
/**
 * A controlled confirm dialog (no built-in trigger). Drive it from a `confirmTarget` state so a
 * page can share one dialog across many row delete buttons — the row action just sets the target.
 * Use {@link ConfirmButton} instead when the trigger is a button rendered inline.
 */
